...
function tickets(ticketNumber) {
  ...
  products.innerHTML = '<p>Order:</p><p>- - - -</p>' + printToTicket.order

  // let createTimer = document.createElement('p')
  // createTimer.id = 'time'
  // createTimer.innerHTML = 'time'
  let ticketTimers = document.createElement('div')
  ticketTimers.innerHTML =
    '<p>' + ticketCounter + '</p><p>-</p>' + printToTicket.timer
...
function customerOrderAlert() {
  ...
  customerOrder.innerHTML =
    '<strong>Can I please order:</strong>' + customerOrderModal
